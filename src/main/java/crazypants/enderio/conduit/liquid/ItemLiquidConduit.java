...
public class ItemLiquidConduit extends AbstractItemConduit implements IAdvancedTooltipProvider {
  ...
  private static ItemConduitSubtype[] subtypes = new ItemConduitSubtype[] {
    ...
    new ItemConduitSubtype(ModObject.itemLiquidConduit.name() + "EnderAdvanced", "enderio:itemLiquidConduitEnderAdvanced")
  };
  ...
  public IConduit createConduit(ItemStack stack, EntityPlayer player) {
    if(stack.getItemDamage() == 1) {
      ...
      return new EnderLiquidConduit();
        ...
        return new EnderLiquidConduitAdvanced();
    }
  ...
  public void addDetailedEntries(ItemStack itemstack, EntityPlayer entityplayer, List list, boolean flag) {
    ...
    if(itemstack.getItemDamage() == 0) {
      ...
      maxIo = Config.enderFluidConduitMaxIoRate;
        ...
        extractRate = Config.enderFluidConduitAdvancedExtractRate;
        maxIo = Config.enderFluidConduitAdvancedMaxIoRate;
