...
public class EnderLiquidConduitAdvanced extends AbstractLiquidConduit {
	  ...
	  private EnderLiquidConduitAdvancedNetwork network;
	      ...
	      if(!getBundle().getEntity().getWorldObj().isRemote) {
	        ...
	        if(res != null && res.component != null) {
	          ...
	          if(connDir == ForgeDirection.UNKNOWN || connDir == faceHit) {
	            ...
	            if(!(n instanceof EnderLiquidConduitAdvanced)) {
	              return false;
	            }
	  ...
	  public boolean setNetwork(AbstractConduitNetwork<?, ?> network) {
	    ...
	    if(!(network instanceof EnderLiquidConduitAdvancedNetwork)) {
	      return false;
	    }
	    this.network = (EnderLiquidConduitAdvancedNetwork) network;
	  ...
	  public boolean canConnectToConduit(ForgeDirection direction, IConduit con) {
	    ...
	    if(!(con instanceof EnderLiquidConduitAdvanced)) {
	      return false;
	    }
	    return true;
	  }
