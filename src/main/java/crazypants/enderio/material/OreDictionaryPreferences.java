...
public final class OreDictionaryPreferences {
    ...
    private final Map<String, ItemStack> preferences = new HashMap<String, ItemStack>();
    private final Map<StackKey, ItemStack> stackCache = new HashMap<StackKey, ItemStack>();
